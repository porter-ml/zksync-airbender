...
#define SORT_KEYS(dir, arg_t, method)                                                                                                                          \
  EXTERN cudaError_t sort_keys_##dir##_##arg_t(void *d_temp_storage, size_t &temp_storage_bytes, const arg_t *d_keys_in, arg_t *d_keys_out,                    \
...
#define SORT_PAIRS(dir, arg_k_t, arg_v_t, method)                                                                                                              \
  EXTERN cudaError_t sort_pairs_##dir##_##arg_k_t##_##arg_v_t(void *d_temp_storage, size_t &temp_storage_bytes, const arg_k_t *d_keys_in, arg_k_t *d_keys_out, \
                                                              const arg_v_t *d_values_in, arg_v_t *d_values_out, const unsigned num_items,                     \
                                                              const int begin_bit, const int end_bit, const cudaStream_t stream) {                             \
