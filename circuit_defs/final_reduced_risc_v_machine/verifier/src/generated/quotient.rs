...
unsafe fn evaluate_every_row_except_last(
    ...
    let every_row_except_last_contribution = {
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    let table_id = *(witness.get_unchecked(74usize));
                    let mut denom = lookup_argument_linearization_challenges[2];
                    denom.mul_assign(&table_id);
                    let mut t = lookup_argument_linearization_challenges[1];
                    t.mul_assign_by_base(&src2);
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    let table_id = *(witness.get_unchecked(78usize));
                    let mut denom = lookup_argument_linearization_challenges[2];
                    denom.mul_assign(&table_id);
                    let mut t = lookup_argument_linearization_challenges[1];
                    t.mul_assign_by_base(&src2);
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    numerator.add_assign(&write_timestamp_contribution);
                    denom.add_assign(&read_timestamp_contribution);
                    let accumulator = *(stage_2.get_unchecked(38usize));
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    numerator.add_assign(&write_timestamp_contribution);
                    denom.add_assign(&read_timestamp_contribution);
                    let accumulator = *(stage_2.get_unchecked(39usize));
                    let previous = *(stage_2.get_unchecked(38usize));
                    let mut individual_term = accumulator;
                    individual_term.mul_assign(&denom);
                    let mut t = previous;
                    t.mul_assign(&numerator);
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(stage_2_next_row.get_unchecked(40usize));
                    let mut t = *(stage_2.get_unchecked(40usize));
                    t.mul_assign(&*(stage_2.get_unchecked(39usize)));
                    individual_term.sub_assign(&t);
                    individual_term
                };
                individual_term
...
unsafe fn evaluate_every_row_except_two(
    ...
    let every_row_except_two_last_contribution = {
        let mut accumulated_contribution = {
            let individual_term = {
                let mut individual_term = *(witness.get_unchecked(134usize));
                let t = *(witness_next_row.get_unchecked(7usize));
                individual_term.sub_assign(&t);
                individual_term
            };
            individual_term
        };
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(witness.get_unchecked(135usize));
                    let t = *(witness_next_row.get_unchecked(51usize));
                    individual_term.sub_assign(&t);
                    individual_term
                };
                individual_term
...
pub unsafe fn evaluate_quotient(
    ...
    let first_row_contribution = {
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(witness.get_unchecked(7usize));
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(witness.get_unchecked(51usize));
